  ...
  return [
    {
      ...
      description:
        "Casual coffee meetup to chat and get to know each other. Perfect for meeting new friends in a relaxed environment!",
      host: userIds[0],
    ...
    },
    {
      ...
      description:
        "Join us for a fun evening of board games! We have classics like Monopoly and Scrabble, plus some newer strategy games.",
      host: userIds[1],
      date: getRandomFutureDate(),
    ...
    },
    {
      ...
      description:
        "Explore the city with fellow photography enthusiasts. Bring your camera and capture some amazing shots!",
      host: userIds[2],
      date: getRandomFutureDate(),
    ...
    },
    {
      ...
      title: "Cooking Class",
      description:
        "Learn to make delicious pasta from scratch! All ingredients provided, just bring your appetite.",
      host: userIds[3],
      date: getRandomFutureDate(),
    ...
    },
    {
      ...
      description:
        "Fun beach volleyball game for all skill levels. Come play and enjoy the sunshine!",
      host: userIds[4],
      date: getRandomFutureDate(),
    ...
    },
    {
      ...
      description:
        "Moderate hiking trail with beautiful views. Perfect for nature lovers and fitness enthusiasts.",
      host: userIds[6],
      date: getRandomFutureDate(),
    ...
    },
    {
      ...
      description:
        "Private viewing of local artist exhibitions. Wine and cheese provided!",
      host: userIds[7],
      date: getRandomFutureDate(),
    ...
    },
    {
      ...
      description:
        "Meet other tech professionals and entrepreneurs. Great for career networking!",
      host: userIds[0],
      date: getRandomFutureDate(),
      location: locations[0],
      maxParticipants: 30,
    ...
    },
    {
      ...
      description:
        "Guided tour of local wineries with tastings. Transportation included!",
      host: userIds[1],
      date: getRandomFutureDate(),
      location: locations[1],
      maxParticipants: 12,
    ...
    },
    {
      ...
      description:
        "Start your day with peaceful yoga in the park. All levels welcome!",
      host: userIds[2],
      date: getRandomFutureDate(),
      location: locations[2],
      maxParticipants: 20,
    ...
    },
    {
      ...
      description:
        "Monthly book club meeting to discuss this month's selection and choose next month's book.",
      host: userIds[3],
      date: getRandomFutureDate(),
      location: locations[3],
      maxParticipants: 10,
    ...
    },
    {
      ...
      description:
        "Sample delicious food from various local food trucks. Live music included!",
      host: userIds[4],
      date: getRandomFutureDate(),
      location: locations[4],
      maxParticipants: 50,
    ...
    },
    {
      ...
      description:
        "Learn salsa dancing with professional instructors. No partner required!",
      host: userIds[5],
      date: getRandomFutureDate(),
      location: locations[5],
      maxParticipants: 24,
    ...
    },
    {
      ...
      title: "Trivia Night",
      description:
        "Test your knowledge at our weekly trivia competition. Prizes for winners!",
      host: userIds[6],
      date: getRandomFutureDate(),
      location: locations[6],
      maxParticipants: 40,
...
export const generateMockRSVPs = (userIds: string[], hangoutIds: string[]) => {
  ...
  for (const hangoutId of hangoutIds) {
    const numParticipants =
      Math.floor(Math.random() * Math.min(userIds.length, 8)) + 2;
