...
export default function About() {
  ...
  const features = [
    {
      title: "Event Finder",
      description: "Interactive map with filters by category and date. Save and discuss events with your group.",
      icon: "🗺️"
    },
    {
      title: "Quick Create",
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn about HangOut - One place to discover events, pick a time together, and confirm who's in." />
      </Head>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-lg text-gray-700 leading-relaxed max-w-lg">
                Our app makes it easier to discover, join, and create hangout events, helping people connect through shared interests.
              </p>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-xl p-6 border border-purple-200 max-w-sm">
                ...
                <p className="text-gray-700">
                  Browse hangouts based on your interests, location, or trending activities.
                </p>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-8 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-purple-200 hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                Connect with friends or meet new people through shared experiences.
              </p>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-white border-t border-zinc-200 py-8 mt-20">
        <div className="max-w-6xl mx-auto px-4 text-center text-zinc-600">
          <p className="text-sm">
            © 2025 {aboutData?.team || 'Infinity'} Team. Built with ❤️ for CS4800.
          </p>
        </div>
      </footer>
    </>
